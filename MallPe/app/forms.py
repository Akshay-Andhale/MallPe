...
class MyPasswordChangeForm(PasswordChangeForm):
    old_password = forms.CharField(label=_('Old Password'),strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'current-password','autfocus':True,'class':'form-control'}))
...
class MyPasswordResetForm(PasswordResetForm):
    email = forms.EmailField(label=_('Email'),max_length=40,widget=forms.EmailInput(attrs={'autocomplete':'email','autfocus':True,'class':'form-control'}))
